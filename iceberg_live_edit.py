...
view_customers_tab_column_2 = [
    [sg.Table(values=[],row_height=36, col_widths=[12,24,24,14,14,14], cols_justification=["c","c","c","c","c","c"], auto_size_columns=False, headings=["Customer No.", "Name", "Contact", "Phone", "Email", "Balance"], num_rows=16, expand_x=True, expand_y=True, font=("",medium_print), enable_events=True, justification="Center", key="-View_Customers_Content-", background_color=detailed_information_color)],
]
...
customers_tab = [
    ...
    [sg.Push(),sg.Input("",(20,1),disabled=False, enable_events=True, key="-Customers_Search_Input-"), sg.Button("New Customer",enable_events=True, key="-New_Customer_Button-"),sg.Button("View Register",enable_events=True, disabled=True, key="-View_Customer_Register_Button-"),sg.Text(" ")],
]
...
view_services_frame_layout = [
    ...
    [sg.Text(f"Memo: ", font=("",small_print), size=(account_information_labels_width,1),justification="left", background_color=overview_information_color)],
    [sg.Multiline(f"Long Description:", font=("",medium_print), autoscroll=True, size=(account_information_labels_width*2,4),justification="left", background_color=detailed_information_color, key="-Service_Notes_Display-")],
    [sg.Push(background_color=overview_information_color), sg.Button(f"Edit SKU", disabled=True,  key="-Edit_Service_Button-")],
]
...
view_services_tab_column_2 = [
    [sg.Table(values=[],row_height=36, col_widths=[24,24,24,24], cols_justification=["c","c","c","c"], auto_size_columns=False, headings=["SKU", "Description", "Price", "Taxable?"], num_rows=16, expand_x=True, expand_y=True, font=("",medium_print), enable_events=True, justification="Center", key="-View_Services_Content-", background_color=detailed_information_color)],
]

services_tab = [
    [sg.Column(view_services_tab_column_1, size=(280,600), element_justification="left"), sg.Column(view_services_tab_column_2, size=(960,600), element_justification="center", expand_x=True, expand_y=False)],
...
view_pos_edit_layout = [
    #[sg.Text(f"",font=("",medium_print), size=(account_information_labels_width,1),justification="left", background_color=overview_information_color)],
    [sg.Input(f"", pad=view_account_labels_pad+1, font=("",small_print), size=(view_customers_data_width,1),justification="left", disabled_readonly_background_color=detailed_information_color, background_color="white", border_width=edit_account_border_width, readonly=True, key="-POS_CustomerName_Input-")],    
    ...
    [sg.Input(f"", pad=view_account_labels_pad+1, font=("",small_print), size=(view_customers_data_width,1),justification="left", disabled_readonly_background_color=detailed_information_color, background_color="white", border_width=edit_account_border_width, readonly=True, key="-POS_Status_Input-")],
    [sg.Input(f"", pad=view_account_labels_pad+1, font=("",small_print), size=(view_customers_data_width,1),justification="left", disabled_readonly_background_color=overview_information_color, background_color="white", border_width=edit_account_border_width, readonly=True, key="-POS_Merchant_Name_Input-")],
]
...
view_pos_labels_layout = [
    ...
    [sg.Text(f"Customer: ",font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=detailed_information_color, key="-POS_Name_Display-")],    
    [sg.Text(f"Email: ",font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=overview_information_color, key="-POS_Category_Display-")],    

    [sg.Text(f"Phone: ",font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=detailed_information_color, key="-POS_Contact_First_Display-")],
    [sg.Text(f"Code: ",font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=overview_information_color, key="-POS_Contact_Last_Display-")],
    [sg.Text(f"Subtotal: ",font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=detailed_information_color, key="-POS_Contact_Preferred_Display-")],
    [sg.Text(f"Sales Tax: ", font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=overview_information_color, key="-POS_Address_Display-")],

    [sg.Text(f"Total: ", font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=detailed_information_color, key="-POS_Phone_Display-")],
    [sg.Text(f"Due Date: ", font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=overview_information_color, key="-POS_Email_Display-")],
    [sg.Text(f"Status: ", font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad),justification="left", background_color=detailed_information_color, key="-POS_Website_Display-")],
    [sg.Text(f"Merchant: ",font=("",small_print), size=(view_customers_labels_width,1),pad=(0, view_account_labels_pad), justification="left", background_color=overview_information_color, key="-POS_Balance_Display-")],
]
...
view_pos_frame_layout = [
    ...
    [sg.Push(background_color=overview_information_color), sg.Button(f"Edit Invoice", disabled=True,  key="-Edit_POS_Button-")],
]
...
pos_tab_column_2 = [
    [sg.Table(values=[],row_height=36, col_widths=[12,20,20,20,16,16], cols_justification=["c","c","c","c","c","c"], auto_size_columns=False, headings=["Number","Customer Name", "Phone", "Email", "Total", "Status"], num_rows=16, expand_x=True, expand_y=True, font=("",medium_print), enable_events=True, justification="Center", key="-View_POSs_Content-", background_color=detailed_information_color)],
]


POS_tab = [
    [sg.Column(pos_tab_column_1, size=(280,600), element_justification="left"), sg.Column(pos_tab_column_2, size=(960,600), element_justification="center", expand_x=True, expand_y=False)],
...
view_ledger_frame_layout = [
    ...
    [sg.Image("Logo_AI.png", key="-Transaction_Image_Button-", size=(258,280),subsample=4,enable_events=True)],
...
tab_keys = ['-Dashboard_Tab-','-Ledger_Tab-','-Reports_Tab-','-Vendors_Tab-','-Customers_Tab-','-Invoicing_Tab-','-Inventory_Tab-','-Owner_Equity_Tab-','-View_Account_Tab-','-View_Properties_Tab-','-View_Services_Tab-']
...
def new_invoice_layout(num):
    num = num + 1
    count_invoices_query = f"""SELECT MAX(Invoice_ID) AS [max_id] FROM tbl_invoices;"""
    invoice_number = db.execute_read_query_dict(icb_session.connection, count_invoices_query)
    invoice_number_str = "1"
    #print(count_transactions_query)
    print("invoice_number")
    print(invoice_number)
    if type(invoice_number) != str:
        max_id = invoice_number[0]['max_id']
        if max_id == None or max_id == "None":
            max_id = 0
            invoice_number_str = f"""{int(max_id)+10001}"""
        else:
            invoice_number_str = f"""{int(max_id)+1}"""
    else:
        icb_session.console_log(invoice_number,icb_session.current_console_messages)
    ...
    new_invoice_column_1 = [
        ...
        [sg.Text("Customer Name: ", font=("",medium_print)), sg.Push(),  sg.Input("",key=f"-Invoice_Customer_Name_{num}-", enable_events=False, size=(20,1))],
        [sg.Text("Customer Address: ", font=("",medium_print)), sg.Push(), sg.Input(size=(20,1), key=f"-Invoice_Customer_Address_{num}-", font=("", medium_print) )],
        [sg.Text("Customer Contact: ", font=("",medium_print)), sg.Push(), sg.Input("",size=(20,1),font=("",medium_print), key=f"-Invoice_Customer_Contact_{num}-")],
        [sg.Text("Status: ", font=("",medium_print)), sg.Push(), sg.OptionMenu(["Due", "Overdue", "Paid"],key=f"-Invoice_Status_{num}-", enable_events=False)],
        [sg.Text("Due Date: ", font=("",medium_print)), sg.Push(), sg.Input("",size=(10,1),key=f"-Invoice_Due_Date_{num}-", enable_events=False),sg.CalendarButton("Select Date", location=(500,500),key=f"-Invoice_Due_Date_Selector_{num}-")],

    ] 
    
    new_invoice_column_2 = [
        [sg.Input("", key=f"-Invoice_Search_Input_{num}-", enable_events=True)],
        [sg.Table([["10001","Yard Work AKA Landscaping Dawhg", "$60.00","True"]],headings=["Sku","Description", "Price", "Taxable"],col_widths=(10,16, 10, 10), num_rows=5,enable_events=True,key=f'-Invoice_Search_Content_{num}-')],
        ...
        [sg.Table([],headings=["Sku","Description", "Price", "Quantity","Total"],num_rows=5)],
        [sg.Text("Subtotal"), sg.Push(), sg.Text("$"), sg.Input(size=(10,1), key=f"-Invoice_Subtotal_{num}-")],
        [sg.Text("Sales Tax"), sg.Input("%", size=(10,1), key=f"-Invoice_SalesTax_Rate_{num}-"),sg.Push(), sg.Text("$"), sg.Input(size=(10,1), key=f"-Invoice_SalesTax_{num}-")],
        [sg.Text("Total"), sg.Push(), sg.Text("$"), sg.Input(size=(10,1), key=f"-Invoice_Total_{num}-")],
    ]
    ...
    new_invoice_layout = [
        [sg.Column(layout=new_invoice_column_1,pad=0, size= (380,400)),sg.Column(new_invoice_column_2,pad=0, size=(500, 400))],
        [sg.Column([[sg.Button(button_text="Submit",size=(20,1),key=f'-Submit_Transaction_Button_{num}-', enable_events=True)],[sg.Sizer(780,0)]],justification="center", size=(780,60),element_justification="center",expand_x=True)],
    ]
...
def new_service_layout(num,service_number):
    ...
    new_service_layout = [
        ...
        [sg.Text("Taxable: ", font=("",medium_print)), sg.Push(), sg.Combo(("True","False"),[0], key=f"-Service_Taxable_{num}-", size=(30,1))],
...
def update_customers_view(window, values):
    ...
    if type(customers) == list:
        ...
        for customer in customers:
            icb_session.customers.append([f"{customer['Customer_ID']}",f"{customer['Customer_Company_Name']}",f"{customer['Preferred_Name']}",f"{customer['Customer_Phone_Number']}",f"{customer['Customer_Email']}", f"TDB"])
...
def update_pos_view(window,values):
    ...
    if len(customers) > 0:
        ...
        for customer in customers:
            get_invoices_query = f"""SELECT * FROM tbl_Invoices WHERE Customer_ID LIKE '%{customers[0]['Customer_ID']}%' OR Tracking_Code LIKE '%{search_term}%' OR Line_Items LIKE '%{search_term}%' OR Subtotal LIKE '%{search_term}%' OR Total LIKE '%{search_term}%' OR Status LIKE '%{search_term}%' OR Payment_Method LIKE '%{search_term}%';"""
            ...
            if len(invoices) > 0 and type(invoices) == list:
                for invoice in invoices:
                    icb_session.invoices.append([f"{invoice['Invoice_ID']}",f"{invoice['Customer_Name']}",f"{invoice['Phone']}",f"{invoice['Email']}",f"{invoice['Total']}", f"{invoice['Total']}"])
            icb_session.window["-View_Customers_Content-"].update(icb_session.invoices)
...
def add_service_to_database(window,values):
    ...
    add_service_query = f"""INSERT INTO tbl_Skus (Sku, Description,  Long_Description, Photo, Price, Taxable, Inventory, Type, Created_Time, Edited_Time)
    VALUES ('{add_service_number}','{add_service_description}',"{add_service_long_description}","{add_service_photo}","{add_service_price}","{add_service_taxable}","False","Service","{current_time[1]}","{current_time[1]}");"""
...
def load_services_tab(window,values):
    ...
    get_services_query = f"""SELECT * FROM tbl_Skus WHERE Sku LIKE '%{search_term}%' OR Description LIKE '%{search_term}%' OR Long_Description LIKE '%{search_term}%' OR Photo LIKE '%{search_term}%' OR Price LIKE '%{search_term}%' OR Taxable LIKE '%{search_term}%' AND Inventory LIKE '%{"""False"""}%' AND Type LIKE '%{"""Service"""}%';"""
...
def load_single_service(window, values, service_id):
    ...
    if type(retrieved_service) == str:
        ...
        window['-Service_Photo_Input-'].update(retrieved_service[0]['Photo'])
    ...
    if event == '__TIMEOUT__':
        ...
        #    icb_session.window, chart_of_accounts_display_content = update_dashboard_statistics(icb_session.window, values)
            ...
            if len(this_index) > 0:
                ...
                event_news, values_news = new_service_window.read(close=True)
                values.update(values_news)      
                if event_news == f"-Submit_Service_Button_{icb_session.num}-":
                    print(f"""Adding {values[f'-Service_Description_{icb_session.num}-']}""")
                    add_service_to_database(icb_session.window,values)    
                    print("Added customer")
                    load_services_tab(icb_session.window,values)      
            ...
            new_invoice_window = sg.Window(title="Record a New Invoice", location=(700,200),layout= invoice_layout, margins=(10,2), resizable=True, size=(920,460))
